          ...
          <div className="bottom-btn">
            ...
            <div className="buttons2">
              <button className="rescue-button" onClick={onRescueButtonClick}>
                <p className="rescue2">Rescue</p>
                <div className="arrow-right">
                  <img className="vector-icon30" alt="" src="/vector7.svg" />
                  <img className="vector-icon31" alt="" src="/vector8.svg" />
                </div>
              </button>
              <button className="adopt-button" onClick={onAdoptButtonClick}>
                <p className="rescue2">Adopt</p>
                <div className="arrow-right">
                  <img className="vector-icon30" alt="" src="/vector7.svg" />
                  <img className="vector-icon31" alt="" src="/vector8.svg" />
                </div>
              </button>
              <button className="donate-button" onClick={onDonateButtonClick}>
                <p className="rescue2">Donate</p>
                <div className="arrow-right">
                  <img className="vector-icon30" alt="" src="/vector7.svg" />
                  <img className="vector-icon31" alt="" src="/vector8.svg" />
                </div>
              ...
              >
                <p className="rescue2">Volunteer</p>
                <div className="arrow-right">
                  <img className="vector-icon30" alt="" src="/vector7.svg" />
                  <img className="vector-icon31" alt="" src="/vector8.svg" />
                </div>
